...
class Cell:
    ...
    def __str__(self) -> str:
        return f"Клетка состоит из {self._cell_number} ячеек"

    def __add__(self, other):
        return Cell(self._cell_number + other._cell_number)

    def __sub__(self, other):
        if self._cell_number > other._cell_number:
            print(f"{self._cell_number} - {other._cell_number}: impossible operation")
        return Cell(self._cell_number - other._cell_number)
    ...
    def make_order(self, per_row: int) -> str:
        rows, tail = self._cell_number // per_row, self._cell_number % per_row
...
print(cell1 + cell2)
print(cell1 - cell2)
print(cell2 - cell1)  # с ошибкой
print(cell1 * cell2)
print(cell1 / cell2)
print((cell1 + cell2).make_order(15))
